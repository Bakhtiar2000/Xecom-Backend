...
export class ReviewService {
    ...
    // ------------------------------- Add Review -------------------------------
    public async addReview(customerId: string, createReviewDto: CreateReviewDto) {
        const { productId, rating, comment } = createReviewDto;

        // Check if customer already reviewed this product
        const existingReview =
            await this.reviewRepository.findByCustomerAndProduct(
                customerId,
                productId,
            );
    ...
    // ------------------------------- Delete Review -------------------------------
    public async deleteReview(customerId: string, reviewId: string) {
        // Check if review exists
